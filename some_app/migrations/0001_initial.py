        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hotel",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="some_app.hotel"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "guest",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="some_app.guest"
                    ),
                ),
                (
                    "hotel",
                ...
                (
                    "room",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="some_app.room"
                    ),
                ),
            ],
        ),
